(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/flex-layout'), require('@lcu/common'), require('path-browserify'), require('@angular/common/http'), require('util'), require('@angular/cdk/tree'), require('@angular/material/tree'), require('rxjs'), require('ngx-markdown')) :
    typeof define === 'function' && define.amd ? define('@lowcodeunit/lcu-documentation-common', ['exports', '@angular/core', '@angular/forms', '@angular/flex-layout', '@lcu/common', 'path-browserify', '@angular/common/http', 'util', '@angular/cdk/tree', '@angular/material/tree', 'rxjs', 'ngx-markdown'], factory) :
    (global = global || self, factory((global.lowcodeunit = global.lowcodeunit || {}, global.lowcodeunit['lcu-documentation-common'] = {}), global.ng.core, global.ng.forms, global.ng.flexLayout, global.common, global.pathBrowserify, global.ng.common.http, global.util, global.ng.cdk.tree, global.ng.material.tree, global.rxjs, global.ngxMarkdown));
}(this, (function (exports, core, forms, flexLayout, common, pathBrowserify, http, util, tree, tree$1, rxjs, ngxMarkdown) { 'use strict';

    pathBrowserify = pathBrowserify && Object.prototype.hasOwnProperty.call(pathBrowserify, 'default') ? pathBrowserify['default'] : pathBrowserify;
    ...
    ***************************************************************************** */
    ...
    var DocsService = /** @class */ (function () {
        ...
        DocsService.ɵprov = core.ɵɵdefineInjectable({ factory: function DocsService_Factory() { return new DocsService(); }, token: DocsService, providedIn: "root" });
    ...
    var originalHeading = new ngxMarkdown.MarkedRenderer().heading;
    function markedOptionsFactory() {
        var renderer = new ngxMarkdown.MarkedRenderer();
        var lastLevel = 0;
    ...
    var LcuDocsComponent = /** @class */ (function () {
        ...
        function LcuDocsComponent(http) {
            this.http = http;
            this.DocChange = new core.EventEmitter();
        ...
        LcuDocsComponent.prototype.GoToDoc = function (docOpt) {
            var docPath = util.isString(docOpt)
                ? docOpt
                : docOpt.Path;
    ...
    var DocsManagerContext = /** @class */ (function (_super) {
        ...
        DocsManagerContext.ɵprov = core.ɵɵdefineInjectable({ factory: function DocsManagerContext_Factory() { return new DocsManagerContext(core.ɵɵinject(core.INJECTOR)); }, token: DocsManagerContext, providedIn: "root" });
    ...
    exports.DocsManagerContext = DocsManagerContext;
    exports.DocsModel = DocsModel;
    exports.DocsService = DocsService;
    exports.DocsUtils = DocsUtils;
    exports.FileFlatNode = FileFlatNode;
    exports.FileNode = FileNode;
    exports.LcuDocsComponent = LcuDocsComponent;
    exports.LcuDocumentationModule = LcuDocumentationModule;
    exports.LcuMarkdownDoc = LcuMarkdownDoc;
    exports.LcuMarkdownDocChangeEvent = LcuMarkdownDocChangeEvent;
    exports.LcuMarkdownDocsConfig = LcuMarkdownDocsConfig;
    exports.markedOptionsFactory = markedOptionsFactory;
    exports.originalHeading = originalHeading;
    exports.ɵ0 = ɵ0;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=lowcodeunit-lcu-documentation-common.umd.js.map
