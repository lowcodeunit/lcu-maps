(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/flex-layout'), require('@lcu/common'), require('@angular/common/http'), require('util'), require('@angular/cdk/tree'), require('@angular/material/tree'), require('rxjs'), require('ngx-markdown')) :
    typeof define === 'function' && define.amd ? define('@lowcodeunit/lcu-documentation-common', ['exports', '@angular/core', '@angular/forms', '@angular/flex-layout', '@lcu/common', '@angular/common/http', 'util', '@angular/cdk/tree', '@angular/material/tree', 'rxjs', 'ngx-markdown'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.lowcodeunit = global.lowcodeunit || {}, global.lowcodeunit['lcu-documentation-common'] = {}), global.ng.core, global.ng.forms, global.ng.flexLayout, global.common, global.ng.common.http, global.util, global.ng.cdk.tree, global.ng.material.tree, global.rxjs, global.ngxMarkdown));
}(this, (function (exports, i0, forms, flexLayout, common, http, util, tree$1, tree, rxjs, ngxMarkdown) { 'use strict';
    ...
    DocsService.ɵprov = i0.ɵɵdefineInjectable({ factory: function DocsService_Factory() { return new DocsService(); }, token: DocsService, providedIn: "root" });
    ...
    var LcuDocsComponent = /** @class */ (function () {
        ...
        function LcuDocsComponent(http) {
            this.http = http;
            this.DocChange = new i0.EventEmitter();
        ...
        LcuDocsComponent.prototype.buildFileNodeFromDoc = function (doc, level, bypassChildren) {
            ...
            if (doc != null) {
                ...
                if (!bypassChildren && doc.Children && doc.Children.length > 0) {
                    ...
                    var docCatch = Object.assign({}, doc);
    ...
    LcuDocsComponent.propDecorators = {
        ...
        Docs: [{ type: i0.Input, args: ['docs',] }],
        DocChange: [{ type: i0.Output, args: ['docChange',] }],
