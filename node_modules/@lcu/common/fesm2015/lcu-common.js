...
const winAny = window;
let FathymSharedModule = FathymSharedModule_1 = class FathymSharedModule {
    //  Fields
    //  API Methods
...
class DAFApplicationConfig {
}
class DAFAPIApplicationConfig extends DAFApplicationConfig {
}
class DAFViewApplicationConfig extends DAFApplicationConfig {
}
...
let ThemeColorDirective = class ThemeColorDirective {
...
let DirectiveModule = DirectiveModule_1 = class DirectiveModule {
    static forRoot() {
        return {
